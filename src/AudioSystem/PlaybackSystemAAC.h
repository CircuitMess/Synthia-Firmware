#ifndef SYNTHIA_FIRMWARE_PLAYBACKSYSTEMAAC_H
#define SYNTHIA_FIRMWARE_PLAYBACKSYSTEMAAC_H
...
class PlaybackSystemAAC {
public:
	PlaybackSystemAAC();
	virtual ~PlaybackSystemAAC();
	void begin();
...
#endif //SYNTHIA_FIRMWARE_PLAYBACKSYSTEMAAC_H
